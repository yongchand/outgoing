...
export default function PrivatePolicy() {
    ...
    return (
      ...
      <div className="w-full mx-auto px-3 sm:px-5 lg:px-6 py-16">
        <div className="prose mx-auto max-w-5xl rounded-sm bg-white py-12 px-4 shadow-md sm:px-16 space-y-4">
          <div className="text-4xl font-extrabold"> Privacy policy </div>
          ...
          <p>      ·    Name </p>
          <p>      ·    Usage Data </p>
          <div className="text-xl"> b. Usage Data </div>
          ...
          <p> When You access the Website by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data. We may also collect information that Your browser sends whenever You visit our Website or when You access the Website by or through a mobile device. </p>
          <p> Information from Third-Party Social Media Websites </p>
          <p> The Company allows You to create an account and log in to use the Website through the following Third-party Social Media Websites: </p>
          <p>      ·   	Google </p>
          <p>      ·    Github </p>
          <p> If You decide to register through or otherwise grant us access to a Third-Party Social Media Website, We may collect Personal data that is already associated with Your Third-Party Social Media Website&apos;s account, such as Your name, Your email address, Your activities or Your contact list associated with that account. </p>
          <p> You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Website&apos;s account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with this Privacy Policy. </p>
          <div className="text-2xl"> 1.2. Tracking Technologies and Cookies </div>
          ...
          <p>      ·    	<b> Web Beacons. </b> Certain sections of our Website and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity). </p>
          <div className="text-2xl"> 1.3. Use of Your Personal Data </div>
          <p> The Company may use Personal Data for the following purposes: </p>
          <p> <b> To provide and maintain our Website, </b> including to monitor the usage of our Website. </p>
          <p> <b> To manage Your Account: </b> to manage Your registration as a user of the Website. The Personal Data You provide can give You access to different functionalities of the Website that are available to You as a registered user </p>
          <p> <b> For the performance of a contract: </b> the development, compliance and undertaking of the purchase contract for the products, items or Websites You have purchased or of any other contract with Us through the Website. </p>
          <p> <b> To contact You: </b> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application&apos;s push notifications regarding updates or informative communications related to the functionalities, products or contracted Websites, including the security updates, when necessary or reasonable for their implementation. </p>
          <p> <b> To provide You </b> with news, special offers and general information about other goods, Websites and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information. </p>
          ...
          <p> <b> For other purposes: </b> We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Website, products, Websites, marketing and your experience. </p>
          <p> We may share Your personal information in the following situations: </p>
          <p>      ·   	<b> With Website Providers: </b> We may share Your personal information with Website Providers to monitor and analyze the use of our Website, to contact You. </p>
          ...
          <p>      ·   	<b> With business partners: </b> We may share Your information with Our business partners to offer You certain products, Websites or promotions. </p>
          ...
          <div className="text-3xl"> 2. Retention of Your Personal Data </div>
          ...
          <div className="text-3xl"> 3. Transfer of Your Personal Data </div>
          ...
          <div className="text-3xl"> 4. Delete Your Personal Data </div>
          <p> You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You. </p>
          <p> Our Website may give You the ability to delete certain information about You from within the Website. </p>
          <p> You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us. </p>
          <p> Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so. </p>
          <div className="text-3xl"> 5. Disclosure of Your Personal Data </div>
          ...
          <p>      ·     Prevent or investigate possible wrongdoing in connection with the Website </p>
          <p>      ·     Protect the personal safety of Users of the Website or the public </p>
          <p>      ·     Protect against legal liability </p>
          <div className="text-3xl"> 6. Security of Your Personal Data </div>
          <p> The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security. </p>
          <div className="text-3xl"> 7. Children&apos;s Privacy  </div>
          ...
          <div className="text-3xl"> 8. Links to Other Websites  </div>
          ...
          <div className="text-3xl"> 9. Changes to this Privacy Policy </div>
