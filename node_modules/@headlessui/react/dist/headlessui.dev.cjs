...
// src/hooks/use-refocusable-input.ts
function useRefocusableInput(ref) {
...
function useResolveButtonType(props, ref) {
  let [type, setType] = (0, import_react39.useState)(() => resolveType(props));
  useIsoMorphicEffect(() => {
...
function useTransition(enabled, elementRef, show, events) {
...
function VirtualProvider(props) {
  ...
  let virtualizer = useVirtualizer({
    ...
    getScrollElement() {
      var _a2;
      return (_a2 = data.optionsRef.current) != null ? _a2 : null;
    },
    overscan: 12
  });
...
function ComboboxFn(props, ref) {
  ...
  let inputRef = (0, import_react54.useRef)(null);
  let buttonRef = (0, import_react54.useRef)(null);
  let optionsRef = (0, import_react54.useRef)(null);
...
function OptionsFn(props, ref) {
  ...
  let labelledBy = useLabelledBy([(_a2 = data.buttonRef.current) == null ? void 0 : _a2.id]);
  let slot = (0, import_react54.useMemo)(() => {
    return {
      open: data.comboboxState === 0 /* Open */,
      option: void 0
  ...
  return /* @__PURE__ */ import_react54.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react54.default.createElement(
    ...
    render({
      ...
      theirProps: {
        ...theirProps,
        children: /* @__PURE__ */ import_react54.default.createElement(Frozen, { freeze: shouldFreeze }, typeof theirProps.children === "function" ? (
          // @ts-expect-error The `children` prop now is a callback function
          (_c = theirProps.children) == null ? void 0 : _c.call(theirProps, slot)
        ) : theirProps.children)
      },
      slot,
...
function useRootContainers({
  ...
  var _a2;
  let mainTreeNodeRef = (0, import_react57.useRef)((_a2 = _mainTreeNodeRef == null ? void 0 : _mainTreeNodeRef.current) != null ? _a2 : null);
  ...
  return {
    ...
    mainTreeNodeRef,
    MainTreeNode: (0, import_react57.useMemo)(() => {
      return function MainTreeNode() {
        if (_mainTreeNodeRef != null)
          return null;
        return /* @__PURE__ */ import_react57.default.createElement(Hidden, { features: 4 /* Hidden */, ref: mainTreeNodeRef });
      };
    }, [mainTreeNodeRef, _mainTreeNodeRef])
  };
}
function useMainTreeNode() {
  let mainTreeNodeRef = (0, import_react57.useRef)(null);
  return {
    mainTreeNodeRef,
    MainTreeNode: (0, import_react57.useMemo)(() => {
      return function MainTreeNode() {
...
function TransitionRootFn(props, ref) {
  ...
  useOnDisappear(show, internalTransitionRef, () => setState("hidden" /* Hidden */));
  useIsoMorphicEffect(() => {
    if (show) {
      setState("visible" /* Visible */);
...
function ChildFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react61.default.createElement(import_react61.default.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react61.default.createElement(TransitionRoot, { ref, ...props })
  ) : (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react61.default.createElement(InternalTransitionChild, { ref, ...props })
  ));
}
...
var InternalDialog = forwardRefWithAs(function InternalDialog2(props, ref) {
  ...
  useInertOthers(inertOthersEnabled, {
    ...
    disallowed: useEvent(() => {
      ...
      return [
        ...
        (_b = (_a2 = mainTreeNodeRef.current) == null ? void 0 : _a2.closest("body > *:not(#headlessui-portal-root)")) != null ? _b : null
      ];
    })
  });
  ...
  )))))))), /* @__PURE__ */ import_react62.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react62.default.createElement(MainTreeNode, null)));
});
...
function DialogFn(props, ref) {
  ...
  if (!inTransitionComponent && open !== void 0 && !rest.static) {
    return /* @__PURE__ */ import_react62.default.createElement(Transition, { show: open, transition: transition2, unmount: rest.unmount }, /* @__PURE__ */ import_react62.default.createElement(InternalDialog, { ref, ...rest }));
  }
  return /* @__PURE__ */ import_react62.default.createElement(InternalDialog, { ref, open, ...rest });
}
...
function PanelFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react62.default.createElement(Wrapper, null, render({
    ourProps,
    theirProps,
    slot,
...
function DisclosureFn(props, ref) {
  ...
  let panelRef = (0, import_react64.useRef)(null);
  let buttonRef = (0, import_react64.useRef)(null);
    ...
    if (isWithinPanel) {
      ...
      switch (event.key) {
        ...
        case "Enter" /* Enter */:
          ...
          (_a2 = state.buttonRef.current) == null ? void 0 : _a2.focus();
          break;
      }
    } else {
      switch (event.key) {
...
function useComputed(cb, dependencies) {
  let [value, setValue] = (0, import_react70.useState)(cb);
  let cbRef = useLatestValue(cb);
...
var ListboxActionsContext = (0, import_react73.createContext)(null);
ListboxActionsContext.displayName = "ListboxActionsContext";
function useActions2(component) {
  let context = (0, import_react73.useContext)(ListboxActionsContext);
  if (context === null) {
...
var ListboxDataContext = (0, import_react73.createContext)(null);
ListboxDataContext.displayName = "ListboxDataContext";
function useData2(component) {
  let context = (0, import_react73.useContext)(ListboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Listbox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_LISTBOX_TAG = import_react73.Fragment;
function ListboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react73.useReducer)(stateReducer4, {
    dataRef: (0, import_react73.createRef)(),
  ...
  let optionsPropsRef = (0, import_react73.useRef)({ static: false, hold: false });
  let buttonRef = (0, import_react73.useRef)(null);
  let optionsRef = (0, import_react73.useRef)(null);
  let listRef = (0, import_react73.useRef)(/* @__PURE__ */ new Map());
  let compare = useByComparator(by);
  let isSelected = (0, import_react73.useCallback)(
  ...
  let data = (0, import_react73.useMemo)(
    () => ({
      ...state,
      value,
      disabled,
  ...
  let actions = (0, import_react73.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react73.useCallback)(() => {
    if (defaultValue === void 0)
      return;
    return theirOnChange == null ? void 0 : theirOnChange(defaultValue);
  }, [theirOnChange, defaultValue]);
  return /* @__PURE__ */ import_react73.default.createElement(
    LabelProvider,
    {
      value: labelledby,
      props: {
        htmlFor: (_a2 = data.buttonRef.current) == null ? void 0 : _a2.id
      },
      slot: {
        open: data.listboxState === 0 /* Open */,
        disabled
    ...
    /* @__PURE__ */ import_react73.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react73.default.createElement(ListboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react73.default.createElement(ListboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react73.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && value != null && /* @__PURE__ */ import_react73.default.createElement(
        FormFields,
        {
          disabled,
          data: { [name]: value },
...
function ButtonFn4(props, ref) {
  ...
  let handleClick = useEvent((event) => {
    ...
    if (data.listboxState === 0 /* Open */) {
      ...
      (_a3 = data.buttonRef.current) == null ? void 0 : _a3.focus({ preventScroll: true });
    } else {
      event.preventDefault();
      actions.openListbox();
    }
...
var SelectedOptionContext = (0, import_react73.createContext)(false);
...
function OptionsFn2(props, ref) {
  ...
  let initialOption = (0, import_react73.useRef)(null);
  ...
  let handleKeyDown = useEvent((event) => {
    ...
    switch (event.key) {
      ...
      case "Escape" /* Escape */:
        ...
        event.stopPropagation();
        (0, import_react_dom8.flushSync)(() => actions.closeListbox());
        (_b = data.buttonRef.current) == null ? void 0 : _b.focus({ preventScroll: true });
        return;
      case "Tab" /* Tab */:
        event.preventDefault();
        event.stopPropagation();
  ...
  let labelledby = useComputed(() => {
    var _a3;
    return (_a3 = data.buttonRef.current) == null ? void 0 : _a3.id;
  }, [data.buttonRef.current]);
  let slot = (0, import_react73.useMemo)(() => {
    return {
      open: data.listboxState === 0 /* Open */
  ...
  let frozenValue = useFrozenData(shouldFreeze, data.value);
  let isSelected = useEvent((compareValue) => data.compare(frozenValue, compareValue));
  return /* @__PURE__ */ import_react73.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react73.default.createElement(
...
function OptionFn2(props, ref) {
  ...
  let usedInSelectedOption = (0, import_react73.useContext)(SelectedOptionContext) === true;
  ...
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react73.useRef)(null);
  ...
  let handleClick = useEvent((event) => {
    ...
    if (data.mode === 0 /* Single */) {
      (0, import_react_dom8.flushSync)(() => actions.closeListbox());
      (_a2 = data.buttonRef.current) == null ? void 0 : _a2.focus({ preventScroll: true });
    }
  });
  let handleFocus = useEvent(() => {
    if (disabled)
...
var DEFAULT_SELECTED_OPTION_TAG = import_react73.Fragment;
function SelectedFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react73.default.createElement(SelectedOptionContext.Provider, { value: true }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, placeholder && shouldShowPlaceholder ? placeholder : children)
    },
    slot,
...
var MenuContext = (0, import_react74.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  let context = (0, import_react74.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react74.Fragment;
function MenuFn(props, ref) {
  let { __demoMode = false, ...theirProps } = props;
  let reducerBag = (0, import_react74.useReducer)(stateReducer5, {
    __demoMode,
    menuState: __demoMode ? 0 /* Open */ : 1 /* Closed */,
    buttonRef: (0, import_react74.createRef)(),
    itemsRef: (0, import_react74.createRef)(),
    items: [],
    searchQuery: "",
    activeItemIndex: null,
    activationTrigger: 1 /* Other */
  ...
  return /* @__PURE__ */ import_react74.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react74.default.createElement(MenuContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react74.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn5(props, ref) {
  ...
  let handleClick = useEvent((event) => {
    ...
    if (state.menuState === 0 /* Open */) {
      ...
      (_a3 = state.buttonRef.current) == null ? void 0 : _a3.focus({ preventScroll: true });
    } else {
      event.preventDefault();
  ...
  let ourProps = mergeProps(
    getFloatingReferenceProps(),
    {
      ...
      "aria-haspopup": "menu",
      "aria-controls": (_a2 = state.itemsRef.current) == null ? void 0 : _a2.id,
...
function ItemsFn(props, ref) {
  ...
  let handleKeyDown = useEvent((event) => {
    ...
    switch (event.key) {
      ...
      case "Escape" /* Escape */:
        ...
        event.stopPropagation();
        (0, import_react_dom9.flushSync)(() => dispatch({ type: 1 /* CloseMenu */ }));
        (_c = state.buttonRef.current) == null ? void 0 : _c.focus({ preventScroll: true });
        break;
      case "Tab" /* Tab */:
        event.preventDefault();
        event.stopPropagation();
  ...
  return /* @__PURE__ */ import_react74.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, render({
    ourProps,
    theirProps,
    slot,
...
var DEFAULT_ITEM_TAG = import_react74.Fragment;
function ItemFn(props, ref) {
  ...
  let internalItemRef = (0, import_react74.useRef)(null);
  ...
  let bag = (0, import_react74.useRef)({
    disabled,
  ...
  return /* @__PURE__ */ import_react74.default.createElement(LabelProvider, null, /* @__PURE__ */ import_react74.default.createElement(DescriptionProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function SectionFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react74.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot: {},
...
function usePopoverContext(component) {
  let context = (0, import_react75.useContext)(PopoverContext);
  if (context === null) {
...
var PopoverAPIContext = (0, import_react75.createContext)(null);
PopoverAPIContext.displayName = "PopoverAPIContext";
function usePopoverAPIContext(component) {
  let context = (0, import_react75.useContext)(PopoverAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Popover /> component.`);
    if (Error.captureStackTrace)
...
var PopoverGroupContext = (0, import_react75.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react75.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react75.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react75.useContext)(PopoverPanelContext);
}
...
function PopoverFn(props, ref) {
  var _a2;
  let { __demoMode = false, ...theirProps } = props;
  let internalPopoverRef = (0, import_react75.useRef)(null);
  ...
  let buttons = (0, import_react75.useRef)([]);
  let reducerBag = (0, import_react75.useReducer)(stateReducer6, {
    __demoMode,
    ...
    panel: null,
    panelId: null,
    beforePanelSentinel: (0, import_react75.createRef)(),
    afterPanelSentinel: (0, import_react75.createRef)(),
    afterButtonSentinel: (0, import_react75.createRef)()
  });
  let [
    {
      popoverState,
  ...
  let isPortalled = (0, import_react75.useMemo)(() => {
    if (!button)
      return false;
    if (!panel)
      return false;
  ...
  let registerBag = (0, import_react75.useMemo)(
    () => ({
  ...
  (0, import_react75.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  let [portals, PortalWrapper] = useNestedPortals();
  ...
  let api = (0, import_react75.useMemo)(
    () => ({ close, isPortalled }),
    [close, isPortalled]
  );
  ...
  return /* @__PURE__ */ import_react75.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react75.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react75.default.createElement(PopoverContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react75.default.createElement(PopoverAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react75.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react75.default.createElement(
    OpenClosedProvider,
    {
    ...
    /* @__PURE__ */ import_react75.default.createElement(PortalWrapper, null, render({
      ourProps,
      theirProps,
      slot,
      defaultTag: DEFAULT_POPOVER_TAG,
      name: "Popover"
    }), /* @__PURE__ */ import_react75.default.createElement(root.MainTreeNode, null))
  ))))));
}
...
function ButtonFn6(props, ref) {
  ...
  let internalButtonRef = (0, import_react75.useRef)(null);
  ...
  let [uniqueIdentifier] = (0, import_react75.useState)(() => Symbol());
  ...
  return /* @__PURE__ */ import_react75.default.createElement(import_react75.default.Fragment, null, render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG6,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react75.default.createElement(
    Hidden,
    {
      id: sentinelId,
...
function BackdropFn2(props, ref) {
  ...
  let internalBackdropRef = (0, import_react75.useRef)(null);
...
function PanelFn3(props, ref) {
  ...
  let internalPanelRef = (0, import_react75.useRef)(null);
  let anchor = useResolvedAnchor(rawAnchor);
  let [floatingRef, style] = useFloatingPanel(anchor);
  let getFloatingPanelProps = useFloatingPanelProps();
  if (anchor) {
      ...
      match(direction.current, {
        [0 /* Forwards */]: () => {
          ...
          for (let element of combined.slice()) {
            if (element.dataset.headlessuiFocusGuard === "true" || ((_a2 = state.panel) == null ? void 0 : _a2.contains(element))) {
  ...
  return /* @__PURE__ */ import_react75.default.createElement(ResetOpenClosedProvider, null, /* @__PURE__ */ import_react75.default.createElement(PopoverPanelContext.Provider, { value: id }, /* @__PURE__ */ import_react75.default.createElement(PopoverAPIContext.Provider, { value: { close, isPortalled } }, /* @__PURE__ */ import_react75.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, visible && isPortalled && /* @__PURE__ */ import_react75.default.createElement(
    Hidden,
    {
    ...
    visible,
    name: "Popover.Panel"
  }), visible && isPortalled && /* @__PURE__ */ import_react75.default.createElement(
    Hidden,
    {
...
function GroupFn2(props, ref) {
  let internalGroupRef = (0, import_react75.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react75.useState)([]);
  ...
  let contextBag = (0, import_react75.useMemo)(
    () => ({
      registerPopover,
      unregisterPopover,
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react75.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render({
    ourProps,
    theirProps,
    slot,
...
var RadioGroupDataContext = (0, import_react76.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react76.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react76.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions3(component) {
  let context = (0, import_react76.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
function RadioGroupFn(props, ref) {
  ...
  let compare = useByComparator(by);
  let [state, dispatch] = (0, import_react76.useReducer)(stateReducer7, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react76.useRef)(null);
  ...
  let firstOption = (0, import_react76.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react76.useMemo)(
  ...
  let radioGroupData = (0, import_react76.useMemo)(
    () => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }),
    [value, firstOption, containsCheckedOption, disabled, compare, state]
  );
  let radioGroupActions = (0, import_react76.useMemo)(
  ...
  let slot = (0, import_react76.useMemo)(() => ({ value }), [value]);
  let reset = (0, import_react76.useCallback)(() => {
    if (defaultValue === void 0)
      return;
    return triggerChange(defaultValue);
  }, [triggerChange, defaultValue]);
  return /* @__PURE__ */ import_react76.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react76.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, /* @__PURE__ */ import_react76.default.createElement(RadioGroupActionsContext.Provider, { value: radioGroupActions }, /* @__PURE__ */ import_react76.default.createElement(RadioGroupDataContext.Provider, { value: radioGroupData }, name != null && /* @__PURE__ */ import_react76.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function OptionFn3(props, ref) {
  ...
  return /* @__PURE__ */ import_react76.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react76.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, render({
    ourProps,
    theirProps,
    slot,
...
function RadioFn(props, ref) {
  ...
  let internalRadioRef = (0, import_react76.useRef)(null);
...
var GroupContext = (0, import_react78.createContext)(null);
GroupContext.displayName = "GroupContext";
var DEFAULT_GROUP_TAG3 = import_react78.Fragment;
function GroupFn3(props) {
  var _a2;
  let [switchElement, setSwitchElement] = (0, import_react78.useState)(null);
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react78.useMemo)(
    () => ({ switch: switchElement, setSwitch: setSwitchElement }),
    [switchElement, setSwitchElement]
  );
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ import_react78.default.createElement(DescriptionProvider, { name: "Switch.Description", value: describedby }, /* @__PURE__ */ import_react78.default.createElement(
    LabelProvider,
    {
      name: "Switch.Label",
      value: labelledby,
    ...
    /* @__PURE__ */ import_react78.default.createElement(GroupContext.Provider, { value: context }, render({
      ourProps,
      theirProps,
      slot: {},
...
function SwitchFn(props, ref) {
  ...
  let groupContext = (0, import_react78.useContext)(GroupContext);
  let internalSwitchRef = (0, import_react78.useRef)(null);
  ...
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react78.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
    onChange == null ? void 0 : onChange(!checked);
    d.nextFrame(() => {
  ...
  return /* @__PURE__ */ import_react78.default.createElement(import_react78.default.Fragment, null, name != null && /* @__PURE__ */ import_react78.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function FocusSentinel({ onFocus }) {
  let [enabled, setEnabled] = (0, import_react79.useState)(true);
  let mounted = useIsMounted();
  if (!enabled)
    return null;
...
var TabsDataContext = (0, import_react80.createContext)(null);
TabsDataContext.displayName = "TabsDataContext";
function useData4(component) {
  let context = (0, import_react80.useContext)(TabsDataContext);
  if (context === null) {
...
var TabsActionsContext = (0, import_react80.createContext)(null);
TabsActionsContext.displayName = "TabsActionsContext";
function useActions4(component) {
  let context = (0, import_react80.useContext)(TabsActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Tab.Group /> component.`);
    if (Error.captureStackTrace)
...
function GroupFn4(props, ref) {
  ...
  let [state, dispatch] = (0, import_react80.useReducer)(stateReducer8, {
    info,
  ...
  let tabsData = (0, import_react80.useMemo)(
  ...
  let tabsActions = (0, import_react80.useMemo)(() => ({ registerTab, registerPanel, change }), []);
  useIsoMorphicEffect(() => {
  ...
  return /* @__PURE__ */ import_react80.default.createElement(StableCollection, null, /* @__PURE__ */ import_react80.default.createElement(TabsActionsContext.Provider, { value: tabsActions }, /* @__PURE__ */ import_react80.default.createElement(TabsDataContext.Provider, { value: tabsData }, tabsData.tabs.length <= 0 && /* @__PURE__ */ import_react80.default.createElement(
    FocusSentinel,
    {
      onFocus: () => {
        var _a2, _b;
...
function ListFn(props, ref) {
  ...
  let slot = (0, import_react80.useMemo)(() => ({ selectedIndex }), [selectedIndex]);
  let theirProps = props;
  let ourProps = {
    ref: listRef,
    role: "tablist",
...
function TabFn(props, ref) {
  ...
  let internalTabRef = (0, import_react80.useRef)(null);
  ...
  let ready = (0, import_react80.useRef)(false);
...
function PanelFn4(props, ref) {
  ...
  let selected = myIndex === selectedIndex;
  let { isFocusVisible: focus, focusProps } = $f7dceffc5ad7768b$export$4e328f61c538687f();
  let slot = (0, import_react80.useMemo)(() => ({ selected, focus }), [selected, focus]);
  let ourProps = mergeProps(
    {
      ref: panelRef,
      id,
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ import_react80.default.createElement(Hidden, { as: "span", "aria-hidden": "true", ...ourProps });
  }
  return render({
    ourProps,
    theirProps,
